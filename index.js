...
export { default as canvas } from '~matyunya/draw-canvas';
import Button from '/Button.svelte';
import ellxify from '~ellx-hub/lib/utils/svelte';
export { plot, label, color } from '~matyunya/plot';
...
export const train = (data, model, shouldRun) => ({
  ...
  __EllxMeta__: {
    component: class {
      constructor({ data, model, shouldRun }, { output }) {
        this.batchLogs = [];
        this.epochLogs = [];
        this.output = output;
